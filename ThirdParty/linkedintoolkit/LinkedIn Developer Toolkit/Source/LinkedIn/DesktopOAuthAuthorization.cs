...
namespace LinkedIn
{
  ...
  public class DesktopOAuthAuthorization : OAuthAuthorization
  {
    ...
    private new DesktopConsumer Consumer => (DesktopConsumer)base.Consumer;
    ...
    public override string AccessToken => this.accessToken;

    /// <summary>
    /// Gets the token manager.
    /// </summary>
    private IConsumerTokenManager TokenManager => base.Consumer.TokenManager;
