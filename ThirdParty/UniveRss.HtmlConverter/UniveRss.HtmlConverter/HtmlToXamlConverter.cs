...
namespace UniveRss.HtmlConverter
{
  ...
  {
  	private static bool ConvertLink = true;
    ...
    #region Internal Methods
																						...
																						bool convertLink)
		    {
		    	...
		    	return ConvertHtmlToXaml(htmlString, asFlowDocument);
		    }
                                           ...
                                           bool asFlowDocument)
    {
      ...
      XmlElement xamlFlowDocumentElement = xamlTree.CreateElement(null,
                                                                  rootElementName,
                                                                  _xamlNamespace);
      ...
      AddBlock(xamlFlowDocumentElement,
               htmlElement,
               new Hashtable(),
               stylesheet,
               sourceContext);
      ...
      xamlFlowDocumentElement.SetAttribute("xml:space",
                                           "preserve");
    ...
    /// </param>
    /// <returns></returns>
    public static string GetAttribute(XmlElement element,
                                    ...
                                    List<XmlElement> sourceContext)
    {
      ...
      {
        htmlNode = AddImplicitParagraph(xamlParentElement,
                                        htmlNode,
                                        inheritedProperties,
                                        stylesheet,
                                        sourceContext);
      ...
      else if (htmlNode is XmlElement)
      {
        ...
        switch (htmlElementName)
        {
          ...
          case "dt": // ???
          case "tt": // ???
            AddParagraph(xamlParentElement,
                         htmlElement,
                         inheritedProperties,
                         stylesheet,
                         sourceContext);
          ...
          case "li":
            ...
            htmlNode = AddOrphanListItems(xamlParentElement,
                                          htmlElement,
                                          inheritedProperties,
                                          stylesheet,
                                          sourceContext);
          ...
          case "img":
            ...
            //AddInline(xamlParentElement, htmlElement, inheritedProperties, stylesheet, sourceContext);

            // changed 5.10.06 - kalle vänskä 
            // if parent element requires block element as child, wraps image in to paragraph
            //if (HtmlSchema.IsBlockElement(xamlParentElement.
            if (xamlParentElement.LocalName == "Section" || xamlParentElement.LocalName == "FlowDocument")
            {
              WrapImageInParagraph(xamlParentElement,
                                   htmlElement,
                                   inheritedProperties,
                                   stylesheet,
                                   sourceContext);
                                 ...
                                 string htmlElementName)
    {
      ...
      if (htmlElementName == "hr")
      {
        ...
        xamlLineBreak = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/null, /*localName:*/Xaml_LineBreak,
                                                                                  _xamlNamespace);
        xamlParentElement.AppendChild(xamlLineBreak);
      }
    }
                                   ...
                                   List<XmlElement> sourceContext)
    {
      ...
      else
      {
        ...
        Hashtable currentProperties = GetElementProperties(htmlElement,
                                                           inheritedProperties,
                                                           out localProperties,
                                                           stylesheet,
                                                           sourceContext);
        ...
        XmlElement xamlElement = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/
          null, /*localName:*/Xaml_Section,
          _xamlNamespace);
        ApplyLocalProperties(xamlElement,
                             localProperties, /*isBlock:*/true);
        ...
        {
          htmlChildNode = AddBlock(xamlElement,
                                   htmlChildNode,
                                   currentProperties,
                                   stylesheet,
                                   sourceContext);
    ...
    /// <summary>
    /// Generates Paragraph element around Image element. Has to be done if parent is Section
    /// and children is Image. Can happen eg. if html img tag is inside blockquote
    /// </summary>
    /// <param name="xamlParentElement">
    /// XmlElement representing Xaml parent to which the converted element should be added
    /// </param>
    ...
    /// true indicates that a content added by this call contains at least one block element
    /// </param>
    private static void WrapImageInParagraph(XmlElement xamlParentElement,
                                             XmlElement htmlElement,
                                             Hashtable inheritedProperties,
                                             CssStylesheet stylesheet,
                                             List<XmlElement> sourceContext)
    {
      // this method added by kv 5.10.2006
      ...
      // add image in to paragraph
      AddImage(xamlElement,
               htmlElement,
               new Hashtable(),
               stylesheet,
               sourceContext);
                                                ...
                                                List<XmlElement> sourceContext)
    {
      ...
      while (htmlNode != null)
      {
        ...
        else if (htmlNode is XmlText)
        {
          ...
          {
            AddTextRun(xamlParagraph,
                       htmlNode.Value);
          }
        }
        else if (htmlNode is XmlElement)
        {
          string htmlChildName = (htmlNode).LocalName.ToLower();
          if (HtmlSchema.IsBlockElement(htmlChildName))
          {
                                  ...
                                  List<XmlElement> sourceContext)
    {
      if (htmlNode is XmlComment)
      {
        DefineInlineFragmentParent((XmlComment) htmlNode,
                                   xamlParentElement);
      }
      else if (htmlNode is XmlText)
      {
        AddTextRun(xamlParentElement,
                   htmlNode.Value);
      }
      else if (htmlNode is XmlElement)
      {
        ...
        {
          case "a":
            AddHyperlink(xamlParentElement,
                         htmlElement,
                         inheritedProperties,
                         stylesheet,
                         sourceContext);
          ...
          default:
            if (HtmlSchema.IsInlineElement(htmlElementName) || HtmlSchema.IsBlockElement(htmlElementName))
            {
              ...
              AddSpanOrRun(xamlParentElement,
                           htmlElement,
                           inheritedProperties,
                           stylesheet,
                           sourceContext);
    ...
    private static void AddTextRun(XmlElement xamlElement,
                                   string textData)
    {
      ...
      for (int i = 0; i < textData.Length; i++)
      {
        ...
        {
          textData = textData.Remove(i--,
                                     1); // decrement i to compensate for character removal
        }
      }
                                     ...
                                     List<XmlElement> sourceContext)
    {
      ...
      string href = GetAttribute(htmlElement,
                                 "href");
      ...
      {
        // check that href works, 
        try
        {
          // NOTE tpa : ignore local xaml files
          if (!href.ToLower().EndsWith(".xaml"))
          {
        ...
        // Create a XAML element corresponding to this html element
        XmlElement xamlElement = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/
          null, /*localName:*/Xaml_Hyperlink,
          _xamlNamespace);
        ApplyLocalProperties(xamlElement,
                             localProperties, /*isBlock:*/false);

        string[] hrefParts = href.Split(new[] {'#'});
        if (hrefParts.Length > 0 && hrefParts[0].Trim().Length > 0)
        {
          xamlElement.SetAttribute(Xaml_Hyperlink_NavigateUri,
                                   hrefParts[0].Trim());
        }
        if (hrefParts.Length == 2 && hrefParts[1].Trim().Length > 0)
        {
          xamlElement.SetAttribute(Xaml_Hyperlink_TargetName,
                                   hrefParts[1].Trim());
        }
        // HACK tpa : manage action in an event handler (e.g. open a browser)
        //xamlElement.SetAttribute("RequestNavigate", "HandleRequestNavigate");
    ...
    private static void DefineInlineFragmentParent(XmlComment htmlComment,
                                 ...
                                 List<XmlElement> sourceContext)
    {
      //  Implement images
      // Convert href attribute into NavigateUri and TargetName
      string src = GetAttribute(htmlElement,
                                "src");
      if (src == null)
      {
        return;
      ...
      // Create a XAML element corresponding to this html element
      XmlElement xamlElement = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/null, /*localName:*/Xaml_Image,
                                                                                         _xamlNamespace);
      ApplyLocalProperties(xamlElement,
                           localProperties, /*isBlock:*/false);

      xamlElement.SetAttribute(Xaml_Image_Source,
                               src.Trim());
      xamlParentElement.AppendChild(xamlElement);

      // if parent element is hyperlink, set it's textdecoration to none
      if (xamlParentElement.Name.ToLower() == "hyperlink")
      {
        xamlParentElement.SetAttribute("TextDecorations",
                                       "None");
      }
                                ...
                                List<XmlElement> sourceContext)
    {
      ...
      Hashtable localProperties;
      Hashtable currentProperties = GetElementProperties(htmlListElement,
                                                         inheritedProperties,
                                                         out localProperties,
                                                         stylesheet,
                                                         sourceContext);
      ...
      XmlElement xamlListElement = xamlParentElement.OwnerDocument.CreateElement(null,
                                                                                 Xaml_List,
                                                                                 _xamlNamespace);
      ...
      {
        // Ordered list
        xamlListElement.SetAttribute(Xaml_List_MarkerStyle,
                                     Xaml_List_MarkerStyle_Decimal);
      }
      else
      {
        // Unordered list - all elements other than OL treated as unordered lists
        xamlListElement.SetAttribute(Xaml_List_MarkerStyle,
                                     Xaml_List_MarkerStyle_Disc);
      }
      ...
      ApplyLocalProperties(xamlListElement,
                           localProperties, /*isBlock:*/true);
                                                 ...
                                                 List<XmlElement> sourceContext)
    {
      ...
      else
      {
        ...
        xamlListElement = xamlParentElement.OwnerDocument.CreateElement(null,
                                                                        Xaml_List,
                                                                        _xamlNamespace);
        xamlParentElement.AppendChild(xamlListElement);
      }
                                    ...
                                    List<XmlElement> sourceContext)
    {
      ...
      Hashtable localProperties;
      Hashtable currentProperties = GetElementProperties(htmlLIElement,
                                                         inheritedProperties,
                                                         out localProperties,
                                                         stylesheet,
                                                         sourceContext);

      XmlElement xamlListItemElement = xamlListElement.OwnerDocument.CreateElement(null,
                                                                                   Xaml_ListItem,
                                                                                   _xamlNamespace);
      ...
      for (XmlNode htmlChildNode = htmlLIElement.FirstChild;
           ...
           htmlChildNode = htmlChildNode != null ? htmlChildNode.NextSibling : null)
      {
        htmlChildNode = AddBlock(xamlListItemElement,
                                 htmlChildNode,
                                 currentProperties,
                                 stylesheet,
                                 sourceContext);
                                 ...
                                 List<XmlElement> sourceContext)
    {
      ...
      Hashtable localProperties;
      Hashtable currentProperties = GetElementProperties(htmlTableElement,
                                                         inheritedProperties,
                                                         out localProperties,
                                                         stylesheet,
                                                         sourceContext);
      ...
      if (singleCell != null)
      {
        ...
        for (XmlNode htmlChildNode = singleCell.FirstChild;
             ...
             htmlChildNode = htmlChildNode != null ? htmlChildNode.NextSibling : null)
        {
          htmlChildNode = AddBlock(xamlParentElement,
                                   htmlChildNode,
                                   currentProperties,
                                   stylesheet,
                                   sourceContext);
      ...
      else
      {
        ...
        XmlElement xamlTableElement = xamlParentElement.OwnerDocument.CreateElement(null,
                                                                                    Xaml_Table,
                                                                                    _xamlNamespace);

        // Analyze table structure for column widths and rowspan attributes
        ArrayList columnStarts = AnalyzeTableStructure(htmlTableElement,
                                                       stylesheet);

        // Process COLGROUP & COL elements
        AddColumnInformation(htmlTableElement,
                             xamlTableElement,
                             columnStarts,
                             currentProperties,
                             stylesheet,
        ...
        while (htmlChildNode != null)
        {
          ...
          if (htmlChildName == "tbody" || htmlChildName == "thead" || htmlChildName == "tfoot")
          {
            ...
            AddTableRowsToTableBody(xamlTableBodyElement,
          ...
          else if (htmlChildName == "tr")
          {
            ...
            htmlChildNode = AddTableRowsToTableBody(xamlTableBodyElement,
                                                    htmlChildNode,
                                                    currentProperties,
                                                    columnStarts,
                                                    stylesheet,
                                             ...
                                             List<XmlElement> sourceContext)
    {
      ...
      if (columnStartsAllRows != null)
      {
        ...
        for (int columnIndex = 0; columnIndex < columnStartsAllRows.Count - 1; columnIndex++)
        {
          ...
          xamlColumnElement = xamlTableElement.OwnerDocument.CreateElement(null,
                                                                           Xaml_TableColumn,
                                                                           _xamlNamespace);
      ...
      else
      {
             ...
             htmlChildNode = htmlChildNode.NextSibling)
        {
          if (htmlChildNode.LocalName.ToLower() == "colgroup")
          {
            ...
            AddTableColumnGroup(xamlTableElement,
                                (XmlElement) htmlChildNode,
                                currentProperties,
                                stylesheet,
                                sourceContext);
    ...
    {
      Hashtable localProperties;
      Hashtable currentProperties = GetElementProperties(htmlColgroupElement,
                                                         inheritedProperties,
                                                         out localProperties,
                                                         stylesheet,
                                                         sourceContext);
    ...
    {
      Hashtable localProperties;
      Hashtable currentProperties = GetElementProperties(htmlColElement,
                                                         inheritedProperties,
                                                         out localProperties,
                                                         stylesheet,
                                                         sourceContext);

      XmlElement xamlTableColumnElement = xamlTableElement.OwnerDocument.CreateElement(null,
                                                                                       Xaml_TableColumn,
                                                                                       _xamlNamespace);
                                                   ...
                                                   List<XmlElement> sourceContext)
    {
      ...
      if (columnStarts != null)
      {
        ...
        InitializeActiveRowSpans(activeRowSpans,
                                 columnStarts.Count);
      }
      ...
      while (htmlChildNode != null && htmlChildNode.LocalName.ToLower() != "tbody")
      {
        if (htmlChildNode.LocalName.ToLower() == "tr")
        {
          ...
          AddTableCellsToTableRow(xamlTableRowElement,
                                  htmlChildNode.FirstChild,
        ...
        else if (htmlChildNode.LocalName.ToLower() == "td")
        {
          ...
          htmlChildNode = AddTableCellsToTableRow(xamlTableRowElement,
                                                  htmlChildNode,
                                                  currentProperties,
                                                  columnStarts,
                                                  activeRowSpans,
                                                   ...
                                                   List<XmlElement> sourceContext)
    {
             ...
             htmlChildNode.LocalName.ToLower() != "tfoot")
      {
        if (htmlChildNode.LocalName.ToLower() == "td" || htmlChildNode.LocalName.ToLower() == "th")
        {
          ...
          ApplyPropertiesToTableCellElement((XmlElement) htmlChildNode,
          ...
          if (columnStarts != null)
          {
            ...
            columnSpan = CalculateColumnSpan(columnIndex,
                                             columnWidth,
                                             columnStarts);
            ...
            xamlTableCellElement.SetAttribute(Xaml_TableCell_ColumnSpan,
                                              columnSpan.ToString());
          ...
          AddDataToTableCell(xamlTableCellElement,
                             htmlChildNode.FirstChild,
                             tdElementCurrentProperties,
                             stylesheet,
                             sourceContext);
                                           ...
                                           List<XmlElement> sourceContext)
    {
           ...
           htmlChildNode = htmlChildNode != null ? htmlChildNode.NextSibling : null)
      {
        ...
        htmlChildNode = AddBlock(xamlTableCellElement,
                                 htmlChildNode,
                                 currentProperties,
                                 stylesheet,
                                 sourceContext);
      ...
      while (htmlChildNode != null && columnWidthsAvailable)
      {
        ...
        switch (htmlChildNode.LocalName.ToLower())
        {
          case "tbody":
            ...
            double tbodyWidth = AnalyzeTbodyStructure((XmlElement) htmlChildNode,
                                                      columnStarts,
                                                      activeRowSpans,
                                                      tableWidth,
                                                      stylesheet);
          ...
          case "tr":
            ...
            double trWidth = AnalyzeTRStructure((XmlElement) htmlChildNode,
                                                columnStarts,
                                                activeRowSpans,
                                                tableWidth,
                                                stylesheet);
        ...
        switch (htmlChildNode.LocalName.ToLower())
        {
          case "td":
            ...
            if (columnWidth != -1)
            {
              ...
              nextColumnIndex = GetNextColumnIndex(columnIndex,
                                                   columnWidth,
                                                   columnStarts,
                                                   activeRowSpans);
    ...
    private static int GetRowSpan(XmlElement htmlTDElement)
    {
      ...
      rowSpanAsString = GetAttribute(htmlTDElement,
                                     "rowspan");
      if (rowSpanAsString != null)
      {
        if (!Int32.TryParse(rowSpanAsString,
                            out rowSpan))
        {
    ...
    /// </param>
    private static void InitializeActiveRowSpans(ArrayList activeRowSpans,
                                                 int count)
    {
    ...
    /// </param>
    private static double GetNextColumnStart(XmlElement htmlTDElement,
                                             double columnStart)
    {
      double columnWidth;
    ...
    private static double GetColumnWidth(XmlElement htmlTDElement)
    {
      ...
      columnWidthAsString = GetAttribute(htmlTDElement,
                                         "width");
      if (columnWidthAsString == null)
      {
        columnWidthAsString = GetCssAttribute(GetAttribute(htmlTDElement,
                                                           "style"),
                                              "width");
      }

      // We do not allow column width to be 0, if specified as 0 we will fail to record it
      if (!TryGetLengthValue(columnWidthAsString,
                             out columnWidth) || columnWidth == 0)
      {
        columnWidth = -1;
      }
      return columnWidth;
    ...
    /// </param>
    private static int CalculateColumnSpan(int columnIndex,
                                           double columnWidth,
                                           ArrayList columnStarts)
    {
    ...
    /// </param>
    private static void ApplyLocalProperties(XmlElement xamlElement,
                                             Hashtable localProperties,
                                             bool isBlock)
    {
      ...
      while (propertyEnumerator.MoveNext())
      {
        switch ((string) propertyEnumerator.Key)
        {
          case "font-family":
            ...
            xamlElement.SetAttribute(Xaml_FontFamily,
          ...
          case "font-variant":
            ...
            break;
          case "font-weight":
            xamlElement.SetAttribute(Xaml_FontWeight,
                                     (string) propertyEnumerator.Value);
            break;
          case "font-size":
            //  Convert from css size into FontSize
            xamlElement.SetAttribute(Xaml_FontSize,
                                     (string) propertyEnumerator.Value);
            break;
          case "color":
            SetPropertyValue(xamlElement,
          ...
          case "text-decoration-underline":
            if (!isBlock)
            {
              ...
              {
                xamlElement.SetAttribute(Xaml_TextDecorations,
                                         Xaml_TextDecorations_Underline);
              }
            }
            break;
          ...
          case "text-indent":
            if (isBlock)
            {
              xamlElement.SetAttribute(Xaml_TextIndent,
                                       (string) propertyEnumerator.Value);
            }
            break;
          ...
          case "text-align":
            if (isBlock)
            {
              xamlElement.SetAttribute(Xaml_TextAlignment,
                                       (string) propertyEnumerator.Value);
            }
            break;
          ...
          case "list-style-type":
            if (xamlElement.LocalName == Xaml_List)
            {
              ...
              xamlElement.SetAttribute(Xaml_List_MarkerStyle,
                                       markerStyle);
            }
            break;
      ...
      if (isBlock)
      {
        if (marginSet)
        {
          ComposeThicknessProperty(xamlElement,
                                   Xaml_Margin,
                                   marginLeft,
                                   marginRight,
                                   marginTop,
        ...
        if (borderColor != null)
        {
          ...
          xamlElement.SetAttribute(Xaml_BorderBrush,
                                   borderColor);
        }
                                                 ...
                                                 string bottom)
    {
      ...
      xamlElement.SetAttribute(propertyName,
                               thickness);
    }

    private static void SetPropertyValue(XmlElement xamlElement,
                                         ...
                                         string stringValue)
    {
      ...
      try
      {
        ...
        {
          xamlElement.SetAttribute(property.Name,
                                   stringValue);
        }
      }
      catch (Exception)
                                                  ...
                                                  List<XmlElement> sourceContext)
    {
      ...
      switch (elementName)
      {
        ...
        case "underline":
          ...
          break;
        case "font":
          //localProperties["font-size"] = "";
          string attributeValue = GetAttribute(htmlElement,
                                               "face");
          if (attributeValue != null)
          {
            localProperties["font-family"] = attributeValue;
          }
          attributeValue = GetAttribute(htmlElement,
                                        "size");
          if (attributeValue != null)
          {
      ...
      HtmlCssParser.GetElementPropertiesFromCssAttributes(htmlElement,
                                                          elementName,
                                                          stylesheet,
                                                          localProperties,
                                                          sourceContext);
    ...
    /// </returns>
    private static string GetCssAttribute(string cssStyle,
                                          string attributeName)
    {
    ...
    /// <returns></returns>
    private static bool TryGetLengthValue(string lengthAsString,
                                          out double length)
    {
      length = Double.NaN;
      ...
      if (lengthAsString != null)
      {
        ...
        {
          lengthAsString = lengthAsString.Substring(0,
                                                    lengthAsString.Length - 2);
          if (Double.TryParse(lengthAsString,
                              out length))
          {
    ...
    /// </remarks>
    private static void ApplyPropertiesToTableCellElement(XmlElement htmlChildNode,
                                                          XmlElement xamlTableCellElement)
    {
      ...
      xamlTableCellElement.SetAttribute(Xaml_TableCell_BorderThickness,
                                        "1,1,1,1");
      xamlTableCellElement.SetAttribute(Xaml_TableCell_BorderBrush,
                                        Xaml_Brushes_Black);
      string rowSpanString = GetAttribute(htmlChildNode,
                                          "rowspan");
      if (rowSpanString != null)
      {
        xamlTableCellElement.SetAttribute(Xaml_TableCell_RowSpan,
                                          rowSpanString);
      }
    }
