...
namespace Sobees.Tools.Threading.Extensions
{
  /// <summary>
  ...
  public static class DispatcherExtensions
  {
    ...
    public static void SetIsEnabledThreadSafe(this UIElement uie,
                                              bool enabled)
    {
      InvokeIfRequired(
        uie,
    ...
    public static void SetTextThreadSafe(this TextBlock tb,
                                         string s)
    {
      InvokeIfRequired(
        tb,
    ...
    /// <param name = "tb">The TextBox</param>
    /// <param name = "s">The string for the Text property</param>
    public static void SetTextThreadSafe(this TextBox tb,
                                         string s)
    {
      InvokeIfRequired(
        tb,
    ...
    public static void SetContentThreadSafe(this ContentControl cc,
                                            string s)
    {
      InvokeIfRequired(
        cc,
    ...
    public static void SetIsCheckedThreadSafe(this RadioButton rb,
                                              bool? val)
    {
      InvokeIfRequired(
        rb,
    ...
    /// <param name = "cb">The CheckBox</param>
    /// <param name = "val">The value to set the IsChecked property to</param>
    public static void SetIsCheckedThreadSafe(this CheckBox cb,
                                              bool? val)
    {
      InvokeIfRequired(
        cb,
    ...
    public static void SetValueThreadSafe(this ProgressBar pb,
                                          double val)
    {
      InvokeIfRequired(
        pb,
